...
const translations = {
  el: {
    ...
    "home.choose.subtitle": "Συνδυάζουμε τεχνική αρτιότητα, σύγχρονη αισθητική και αυθεντική φιλοξενία για να ζήσετε μια εμπειρία ομορφιάς που διαρκεί.",
    ...
    "home.choose.stats.experience": "Χρόνια εμπειρίας",
  ...
  en: {
    ...
    "home.choose.stats.experience": "Years of Experience",
